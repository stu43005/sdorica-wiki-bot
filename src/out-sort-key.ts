...
const TABLE_KEYS: Record<string, string[]> = {
	...
	AdventureWeekPoint: ["id", "groupId", "points"],
	AdventureWeekRank: [
		"id",
		"groupId",
		"image",
	...
	Diligents: [
		...
		"giveType",
		"giveLinkId",
		"giveAmount", // dropExtraItem
		"abilityIncrease", // hpIncrease, atkIncrease
		"buffId",
		"buffLevel", // buffIncrease
	],
	DropItems: [
		"groupId",
		"subgroupId",
	...
	Quests: [
		...
		"extraSettingId",
		"dropRule" /* 掉落規則 */,
		"displayDropTextFirst",
		"displayDropText" /* 掉落欄位訊息 */,
		"dropGroupIdFirst",
		"dropGroupId" /* 實際掉落物列表ID */,
		"displayDropItemFirst",
		"displayDropItem" /* 顯示掉落物 */,
		"ringFirst",
		"ring" /* 魂晶碎片 */,
		"expPlayerFirst",
		"expPlayer" /* 諦視者經驗 */,
	...
	TavernMission: [
		...
		"extraDropItem",
		"displayDropItem",
		"displayExtraDropItem",
		"homeExp",
		"monsterExp",
		"monsterLv",
		"monsterLvPenaltyRatio",
		"monsterLvPenaltyMax",
		"expressConversion",
		"expressCurrency",
	],
